...
void OrdinaryTriangleMesh::setupGeometry(const MeshBuffer &meshBuffer)
{
...
void OrdinaryTriangleMesh::parseTriangleMesh(tinyobj::attrib_t &outAttrib, std::vector<tinyobj::shape_t> &outShapes, std::vector<tinyobj::material_t> &outMaterials)
{
...
OrdinaryTriangleMesh::MeshBuffer OrdinaryTriangleMesh::allocateGeometryBuffers(const tinyobj::attrib_t &attrib)
{
...
void OrdinaryTriangleMesh::packGeometryBuffers(MeshBuffer &meshBuffer, const tinyobj::attrib_t &attrib, const std::vector<tinyobj::shape_t> &shapes)
{
...
void OrdinaryTriangleMesh::unmapGeometryBuffers(MeshBuffer & meshBuffer)
{
